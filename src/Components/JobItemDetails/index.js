      ...
      <div className="full-job-item-container">
        <div className="job-items-container">
          ...
          <ul className="skills-list-container">
            {skills.map(eachSkill => (
              <li key={eachSkill.id} className="skill-list-items">
                <div className="skill-container">
                  ...
                  />
                  <p className="image-name">{eachSkill.name}</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <ul className="similar-cards">
          {similarJobItemList.map(eachItem => (
            <SimilarJobItems key={eachItem.id} jobDetails={eachItem} />
          ))}
        </ul>
      </div>
    )
